module.exports.sampleHtmlTemplate = `
...
<body>
    <center class="wrapper" data-link-color="#42ee99"
        data-body-style="font-size:14px; font-family:arial,helvetica,sans-serif; color:#002e5d; background-color:#FFF;">
        <div class="webkit">
                                ...
                                <td width="100%">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td>
                                                <center>
                                                    <table style="width:680px;font-family:'DengXian',sans-serif"
                                                        width="680">
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:680px;font-size:15px;font-family:'DengXian',sans-serif;text-align:left"
                                                                    width="680">
                                                                    <center>
                                                                        If you cannot read the following message, please
                                                                        click <a href="#" target="_blank"
                                                                            data-saferedirecturl="#">here</a>.
                                                                    </center>
                                                                    <br>
                                                                    <img alt="banner"
                                                                        src="https://demo.brandactivation.hk/exvent/banner.jpg"
                                                                        style="width:680px" width="680"
                                                                        class="CToWUd a6T" data-bit="iit" tabindex="0">
                                                                    <div class="a6S" dir="ltr"
                                                                        style="opacity: 0.01; left: 884.5px; top: 568.5px;">
                                                                        <span data-is-tooltip-wrapper="true" class="a5q"
                                                                            jsaction="JIbuQc:.CLIENT"><button
                                                                                ...
                                                                                jslog="91252; u014N:cOuCgd,Kr2w4b,xr6bB; 4:WyIjbXNnLWY6MTgzMjgyOTEyNjYyNjM0NDQ3MiJd; 43:WyJpbWFnZS9qcGVnIl0."><span
                                                                            ...
                                                                            <div class="ne2Ple-oshW8e-J9" id="tt-c15"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    We hope the event offered valuable insights and
                                                                    sparked opportunities for future collaborations,
                                                                    enabling us to better serve our customers and
                                                                    achieve collective success.
                                                                    <br>
                                                                    <br>
                                                                    To revisit the memorable moments, we're excited to
                                                                    share a collection of highlight photos from the
                                                                    event, available at
                                                                    <br>
                                                                    <br>
                                                                    <center><img height="200" src="{{qrCodeUrl}}"
                                                                            ...
                                                                            tabindex="0">
                                                                        <div class="a6S" dir="ltr"
                                                                            style="opacity: 0.01; left: 644.469px; top: 1572.08px;">
                                                                            <span data-is-tooltip-wrapper="true"
                                                                                ...
                                                                                <div class="ne2Ple-oshW8e-J9"
                                                                                    id="tt-c14" role="tooltip"
                                                                                    aria-hidden="true">Download</div>
                                                                            </span>
                                                                        </div>
                                                                    </center>
                                                                    <br>
                                                                    ...
                                                                    and the continued success that awaits us.
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
